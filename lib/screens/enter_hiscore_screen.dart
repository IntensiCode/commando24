...
class EnterHiscoreScreen extends GameScriptComponent with HasAutoDisposeShortcuts {
  ...
  onLoad() async {
    ...
    textXY('${game_state.score}', center_x, line_height * 6, scale: 2);

    textXY('Round', center_x, line_height * 8);
    textXY('${game_state.level_number_starting_at_1}', center_x, line_height * 9, scale: 2);
